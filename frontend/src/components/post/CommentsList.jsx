    ...
    <div className="post-comments">
      <form onSubmit={handleSubmit(submit)}>
        <div>
          <div className="create-comment">
            <input
              ...
              ref={register({
                ...
                maxLength: {
                  value: 30,
                  message: 'Comment must be smaller than 30 characters long.',
                },
              })}
            />
            <Button
          ...
          {errors.text && (
            <p className="comment-error">{errors.text.message}</p>
          )}
        </div>
      </form>
      ...
      {countOfComments - 3 > comments ? (
        comments > 1 && (
          <span className="no-more-items">Does not have more comments</span>
        )
      ) : (
        <span onClick={showComments} className="more-items">
          show more comments
        </span>
      )}
...
export default connect(mapStateToProps, { createComment, getPostComments })(
  CommentsList
);
